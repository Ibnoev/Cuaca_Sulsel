...
if st.sidebar.button("🔍 Tampilkan Visualisasi"):
    ...
    # Tambahkan Titik Bandara Sultan Hasanuddin
    bandara_lat = -5.0617
    bandara_lon = 119.5540
    ax.plot(bandara_lon, bandara_lat, marker='o', color='red', markersize=5, transform=ccrs.PlateCarree())
    ax.text(bandara_lon + 0.1, bandara_lat, "Sultan Hasanuddin (WAAA)",
            color='red', fontsize=8, transform=ccrs.PlateCarree())
